...
function Navbar() {
  ...
  return (
    <>
      <nav className="paddingX w-full flex items-center py-5 fixed top-0 z-30 bg-transparent backdrop-filter backdrop-blur-xl bg-opacity-60">
        {avatarToggle && <AvatarModal />}
        <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
          <div className="flex items-center gap-6">
            <div
              className="w-7 h-9 object-contain rounded-full relative cursor-pointer"
            ...
            <Link href="/">
              <p className="dark:text-ctnPrimaryDark text-ctnPrimaryLight text-[18px] font-bold cursor-pointer flex">
                Yücel Gümüş&nbsp;
                <span className="lg:block hidden"> | Yazılım Mühendisi</span>
              </p>
            </Link>
          </div>
